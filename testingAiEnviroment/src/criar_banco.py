...
opcoes = [
    ...
    ("criacao_sala_ensino", "0", "feedback"),
    ("criacao_sala_pesquisa", "0", "feedback"),
    ("criacao_sala_plataforma", "0", "menu_docente"),
    ("cadastro_usuarios_plataforma", "0", "menu_docente"),
    ("cadastro_usuarios_ensino", "0", "feedback"),
    ("cadastro_usuarios_pesquisa", "0", "feedback"),
